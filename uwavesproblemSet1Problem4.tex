...
\begin{equation}\label{eqn:uwavesproblemSet1Problem4:20}
\begin{aligned}
\int \BD \cdot \ncap dA
&= 2 \epsilon E w l
\\ &= Q,
...
\begin{equation}\label{eqn:uwavesproblemSet1Problem4:40}
...
\begin{equation}\label{eqn:uwavesproblemSet1Problem4:60}
\BE = -\frac{Q}{\epsilon w l} \ycap.
\end{equation}

The voltage difference between the plates is

\begin{equation}\label{eqn:uwavesproblemSet1Problem4:80}
\begin{aligned}
V
&= \int_0^d E dl
...
\begin{equation}\label{eqn:uwavesproblemSet1Problem4:100}
\begin{aligned}
C'
&= \frac{Q/l}{V}
...
\begin{equation}\label{eqn:uwavesproblemSet1Problem4:140}
\begin{aligned}
\oint \BD \cdot d\Bl
&=
2 H w \\ &= I,
...
or
\begin{equation}\label{eqn:uwavesproblemSet1Problem4:160}
H = \frac{I}{2w}.
\end{equation}
...
\begin{equation}\label{eqn:uwavesproblemSet1Problem4:180}
H = \frac{I}{w}.
\end{equation}

Calculating the flux through the side we have

\begin{equation}\label{eqn:uwavesproblemSet1Problem4:200}
\begin{aligned}
\Phi
&= \int \BB \cdot d\BA
\\ &= \mu H l d
...
\begin{equation}\label{eqn:uwavesproblemSet1Problem4:220}
L'
= \frac{\Phi/l}{I},
\end{equation}
...
\begin{equation}\label{eqn:uwavesproblemSet1Problem4:260}
\begin{aligned}
Z_0
&= \sqrt{\frac{L}{C}}
\\ &= \sqrt{ \frac{\mu d}{w}
...
or
\begin{equation}\label{eqn:uwavesproblemSet1Problem4:280}
Z_0
= \frac{d}{w} \eta.
\end{equation}
...
\begin{equation}\label{eqn:uwavesproblemSet1Problem4:360}
\begin{aligned}
\alpha
...
\begin{equation}\label{eqn:uwavesproblemSet1Problem4:420}
Z_0 = 37.8 \Omega.
\end{equation}
\makeSubAnswer{}{uwaves:problemSet1:4g}
With
\begin{equation}\label{eqn:uwavesproblemSet1Problem4:440}
\begin{aligned}
...
\begin{equation}\label{eqn:uwavesproblemSet1Problem4:500}
L \equiv e^{-2 \alpha}
\end{equation}

This is of interest because the voltage is of the from
\begin{equation}\label{eqn:uwavesproblemSet1Problem4:520}
V = V_0 e^{-\alpha z} e^{-j \beta z},
\end{equation}

so the ratio of powers relative to the \( z = 0 \) power is

\begin{equation}\label{eqn:uwavesproblemSet1Problem4:540}
\begin{aligned}
\frac{P}{P_0}
&=
...
\begin{equation}\label{eqn:uwavesproblemSet1Problem4:560}
e^{-2 \alpha \lambda},
\end{equation}

whereas the loss factor for one meter ( \( z = 1 \) ), is

\begin{equation}\label{eqn:uwavesproblemSet1Problem4:580}
L = e^{-2 \alpha }.
\end{equation}

In \si{dB} losses are

\begin{equation}\label{eqn:uwavesproblemSet1Problem4:600}
\begin{aligned}
-10 \log_{10} L
&=
