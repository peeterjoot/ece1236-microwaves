...
\begin{equation}\label{eqn:uwavesproblemSet1Problem2:20}
Z_0 = \sqrt{\frac{ R + j \omega L }{ G + j \omega C }},
\end{equation}
we know \( R, C, G \), but not \( L \).  We'd found that
\begin{equation}\label{eqn:uwavesproblemSet1Problem2:40}
v_\phi = \inv{\sqrt{L C}},
\end{equation}
for lossless, low-loss, and distortionless lines.  If we assume that is the case here too, and
\begin{equation}\label{eqn:uwavesproblemSet1Problem2:60}
\begin{aligned}
v_\phi
...
\end{equation}
we have
\begin{equation}\label{eqn:uwavesproblemSet1Problem2:80}
\begin{aligned}
L
&= \inv{v_\phi^2 C}
...
\begin{equation}\label{eqn:uwavesproblemSet1Problem2:300}
\begin{aligned}
\omega L
&= 2( 14 ) \pi f
\\ &= 88 f.
...
\begin{equation}\label{eqn:uwavesproblemSet1Problem2:100}
\begin{aligned}
Z_0
...
\begin{equation}\label{eqn:uwavesproblemSet1Problem2:120}
\begin{aligned}
\gamma
...
Let's see how the low-loss line approximation fares for both the real (\(\alpha\)) and imaginary (\(\beta\)) components of \( \gamma \)? For all of these frequencies, we have
