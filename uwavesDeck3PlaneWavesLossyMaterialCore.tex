...
\begin{equation}\label{eqn:uwavesLecture3:560}
R_{\textrm{RF}} = \inv{\sigma} \frac{l}{2 \pi b \delta_\txts}.
\end{equation}

Since \( A_{\textrm{RF}} \ll A = \pi b^2 \),

\begin{equation}\label{eqn:uwavesLecture3:580}
...
\begin{equation}\label{eqn:uwavesLecture3:520}
\begin{aligned}
...
\begin{equation}\label{eqn:uwavesLecture3:600}
